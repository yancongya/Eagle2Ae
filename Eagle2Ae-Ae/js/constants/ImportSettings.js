...
// 存储键值
const STORAGE_KEYS = {
    IMPORT_SETTINGS: 'eagle2ae_importSettings',
    USER_PREFERENCES: 'eagle2ae_userPreferences',
    RECENT_FOLDERS: 'eagle2ae_recentFolders',
    EXPORT_SETTINGS: 'eagle2ae_exportSettings'
};
...
const DEFAULT_USER_PREFERENCES = {
    ...
    lastUsedExportMode: ExportModes.PROJECT_ADJACENT,
...
const UI_STATE_RULES = {
    ...
    exportCustomFolderVisible: (settings) => settings.exportSettings.mode === ExportModes.CUSTOM_FOLDER
};
