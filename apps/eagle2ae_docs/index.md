...
Eagle2Ae AE 扩展 v2.4.0 带来了革命性的新功能和改进：

### 🚀 多面板支持
支持同时打开多个扩展面板实例，每个面板拥有独立的配置和预设文件。

### 🎨 UI 控制系统
全新的UI控制系统，支持主题切换、语言切换、组件显示控制等个性化功能。

### 📁 拖拽导入增强
增强了拖拽导入功能，支持文件夹拖拽、序列帧自动检测、项目内文件检测等。

### 📋 剪贴板导入优化
优化了剪贴板导入功能，支持剪贴板图片自动检测和智能重命名。
