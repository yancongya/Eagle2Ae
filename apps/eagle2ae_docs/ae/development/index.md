...
### API 参考
- **[概述](../api/)** - API 参考概览
- **[前端 JS API](../api/frontend-js-api.md)** - 前端 JavaScript API 详细说明
- **[智能对话框系统](../api/dialog-system.md)** - 对话框系统完整 API 参考
- **[虚拟弹窗系统](../api/virtual-dialog-system.md)** - 演示模式下的虚拟弹窗实现
- **[状态监控器](../api/status-monitor.md)** - 状态监控器的 API 说明
- **[批量状态检测器](../api/batch-status-checker.md)** - 批量状态检测的实现细节
- **[轮询管理器](../api/polling-manager.md)** - 轮询机制的管理 API
- **[连接监控器](../api/connection-monitor.md)** - 连接状态监控的详细说明
- **[错误处理系统](../api/error-handling.md)** - 错误处理机制的 API 参考
...
- **[性能监控](../api/performance-monitoring.md)** - 性能监控的 API 参考
