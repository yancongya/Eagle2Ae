...
- **导入行为**: 决定素材是**仅存入项目面板**，还是**自动添加到当前合成**。插件提供了4个独立的导入行为选项：不导入合成、创建预合成、当前时间、时间轴开始。
...
理解了如何处理从Eagle导入的素材后，下一步就是学习如何将您在AE中的创作成果反向归档到Eagle。请阅读 **[《4-工作流：从AE中提取并归档素材》](./4-extract-archive-assets-from-ae.md)**。